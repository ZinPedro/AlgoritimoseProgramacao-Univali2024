...
int main()
{
    ...
    int p = 1, chave = 0, totem = 0, clear = 0, r, i, tentativa, tempomaximo = 10, tempo = 0, m = 0, c = 0, d = 0, u = 0, ancora1 = 0, ancora2 = 0, ancora3 = 0, n=0, r1=0, r2 =0, r3=0;
    ;
    ...
    case 'i': ////MOSTRAR INTEGRANTES////
        while (v == 'v' || v == 'V')
        {
            ...
            if (v == 'V' || v == 'v')
            {
                ...
                cout << "\nDigite (j) para jogar ";
                cout << "\nDigite (s) para sair \n";
                cout << "\nSiga ,restritamente, todas as instrucoes para uma melhor experiencia :D. \n";
                cin >> menu;
                if (menu == 'j' || menu == 'J')
                {
                    break;
    ...
    case 'j': ////JOGAR////
        while (p != 69 && p != 70)
        {
            if (p == 1)
            {
                ...
                cout << "digite a direção, 'N' para norte, 'S' para Sul, 'L' leste ou 'O' oeste e depois precione o enter (só digite direções possíveis de se locomover de acordo com a sua localização) " << endl;
            ...
            if (p == 52)
            {
                ...
                cout << "Voce ficou preso no cofre, acerte a senha para conseguir fugir." << endl;
                ...
                for (i = 0; i <= 5; i++)
                {
                    ...
                    ancora3 = d;
                    r3 = r * 10; 
                    while(r1==ancora1 || r2==ancora2 || r3==ancora3){
                       r = rand() % 6  + 1 ;   
                       r3 = r * 10;  
                       r2 = r * 100; 
                       r1 = r * 1000;   
                ...
                do
                {
                    cout << "Digite um numero de 4 digitos, você tem 10 chances: ";
                    cin >> tentativa;
                    if (tentativa == n)
                    {
                        cout << "Parabéns! Você acertou o código! Digite O para sair pela direcao oeste." << endl;
                        cin >> direcao;
                        switch (direcao)
                        {
                        case 'O':
                    ...
                    {
                        int tentativar = n, numerosdetentativa = tentativa, numeroscorretos = 0;

                        for (i = 0; i <= 3; i++)
                        {
                            if ((tentativar % 10) == (numerosdetentativa % 10))
                            {
                                numeroscorretos++;
                            }
                            tentativar= tentativar /10;
                            numerosdetentativa= numerosdetentativa/ 10;
                        }
                        cout << "Voce acertou " << numeroscorretos << " numeros." << endl;
                        cout << "Não é o código correto. Tente novamente." << endl;
                        tempo++;
                    }
                } while (tempo < tempomaximo);
                if (tempo >= tempomaximo)
                {
                    cout << "Você excedeu o número máximo de tentativas, o cofre travou e voce ficou preso pra sempre... GAME OVER  " << r << endl;
                    p=70;
                }
            }
            if (p == 54)
